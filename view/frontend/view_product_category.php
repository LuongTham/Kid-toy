<div class="special-collection">
			  <div class="tabs-container">
				<div class="clearfix">
				  <h2 style="font-weight: bold; color:red;">Category name</h2>
				</div>
			  </div>
			  <div class="tabs-content row">
				<div id="content-tabb1" class="content-tab content-tab-proindex">
						...
						<div class="info">
						  ...
						  <div class="action-btn">
							<form action="cart/add" method="post" enctype="multipart/form-data" id="product-actions-1168979">
							  <a href="index.php?controller=cart&id=<?php echo $rows->pk_product_id; ?>" class="button">Add to cart</a>
							</form>
						  </div>
						</div>
					  </div>
                  ...
                  <ul class="pagination pull-right" style="margin-top: 0px !important; padding-right: 15px;">
                    ...
                    <li><a href="index.php?controller=product_category&id=<?php echo $id; ?>&p=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                	<?php endfor; ?>
                  </ul>              
                <!-- end paging -->
				  </div>
