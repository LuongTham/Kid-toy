...
<div class="product-detail" itemscope itemtype="http://schema.org/Product">
          ...
          <div class="top">
            <div class="row">
              ...
              <div class="col-xs-12 col-md-6 info">
                ...
                <p class="vendor">Category Product:&nbsp; <span>
                  <?php 
                ...
                <form action="/cart/add" method="post" enctype="multipart/form-data" class="product-form">
                  <div class="action-btn">
                    <a href="index.php?controller=cart&act=add&id=<?php echo $record->pk_product_id; ?>" class="button product-add-to-cart">Add to cart</a>
                  </div>
                </form>
              </div>
            </div>
          ...
          <div class="middle">
            <ul class="list-unstyled navtabs">
              <li><a href="#tab1" class="head-tabs head-tab1 active" data-src=".head-tab1">Product details</a></li>
            </ul>
