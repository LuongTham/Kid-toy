		...
		public function __construct(){
			...
			switch($act){
				case "delete":
					...
					model::execute("delete from tbl_order where pk_order_id=$id");
			...
			$arr = model::list_all("select * from tbl_order inner join tbl_customer on tbl_order.customer_id = tbl_customer.customer_id order by trangthai,order_id desc limit $from,$record_per_page");
			//load view
